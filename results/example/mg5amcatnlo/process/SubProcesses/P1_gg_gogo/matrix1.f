...
C     
C     Process: g g > go go WEIGHTED<=2 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FVIGOX(W(1,3),W(1,1),GGI,MGO,WGO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL IOVGOX(W(1,5),W(1,4),W(1,2),GGI,AMP(2))
      CALL FVOGOX(W(1,4),W(1,1),GGI,MGO,WGO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL IOVGOX(W(1,3),W(1,5),W(1,2),GGI,AMP(3))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+2D0*(+AMP(1)+AMP(3))
      JAMP(2,1)=+2D0*(-AMP(1)-AMP(2))
      JAMP(3,1)=+2D0*(+AMP(2)-AMP(3))
      JAMP(4,1)=+2D0*(-AMP(1)-AMP(2))
      JAMP(5,1)=+2D0*(+AMP(2)-AMP(3))
      JAMP(6,1)=+2D0*(+AMP(1)+AMP(3))
