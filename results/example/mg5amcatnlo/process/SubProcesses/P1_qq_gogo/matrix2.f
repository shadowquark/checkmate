...
C     
C     Process: c c~ > go go WEIGHTED<=2 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL IOVGOX(W(1,3),W(1,4),W(1,5),GGI,AMP(1))
      CALL IXXXXX(P(0,4),MGO,NHEL(4),-1*IC(4),W(1,5))
      CALL OXXXXX(P(0,3),MGO,NHEL(3),+1*IC(3),W(1,6))
      CALL HIOXXX(W(1,1),W(1,6),GQLGOM,MCL,WCL,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL IOSXXX(W(1,5),W(1,2),W(1,7),GQLGOP,AMP(2))
      CALL HIOXXX(W(1,1),W(1,6),GQRGOM,MCR,WCR,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL IOSXXX(W(1,5),W(1,2),W(1,7),GQRGOP,AMP(3))
      CALL HIOXXX(W(1,1),W(1,4),GQLGOM,MCL,WCL,W(1,7))
C     Amplitude(s) for diagram number 4
      CALL IOSXXX(W(1,3),W(1,2),W(1,7),GQLGOP,AMP(4))
      CALL HIOXXX(W(1,1),W(1,4),GQRGOM,MCR,WCR,W(1,7))
C     Amplitude(s) for diagram number 5
      CALL IOSXXX(W(1,3),W(1,2),W(1,7),GQRGOP,AMP(5))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+AMP(1)-AMP(4)-AMP(5)
