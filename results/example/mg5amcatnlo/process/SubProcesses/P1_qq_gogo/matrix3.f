...
C     
C     Process: d d~ > go go WEIGHTED<=2 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      ...
      CALL HIOXXX(W(1,1),W(1,6),GQLGOM,MDL,WDL,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL IOSXXX(W(1,5),W(1,2),W(1,7),GQLGOP,AMP(2))
      CALL HIOXXX(W(1,1),W(1,6),GQRGOM,MDR,WDR,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL IOSXXX(W(1,5),W(1,2),W(1,7),GQRGOP,AMP(3))
      CALL HIOXXX(W(1,1),W(1,4),GQLGOM,MDL,WDL,W(1,7))
C     Amplitude(s) for diagram number 4
      CALL IOSXXX(W(1,3),W(1,2),W(1,7),GQLGOP,AMP(4))
      CALL HIOXXX(W(1,1),W(1,4),GQRGOM,MDR,WDR,W(1,7))
