...
void AnalysisHandlerCMS_13TeV::bookAnalysis(std::string analysisName,
    ...
    if(analysisName == "cms_pas_sus_15_011")
        ...
        a = new Cms_1709_08601_13();
    else if(analysisName == "cms_1709_08908")
        a = new Cms_1709_08908();
    else if(analysisName == "cms_1711_00431")
        a = new Cms_1711_00431();
    else if(analysisName == "cms_1801_01846")
        a = new Cms_1801_01846();
    else if(analysisName == "cms_1803_05485")
        a = new Cms_1803_05485();
    else if(analysisName == "cms_1803_06292")
        a = new Cms_1803_06292();
    else if(analysisName == "cms_1806_05264")
        a = new Cms_1806_05264();
    else if(analysisName == "cms_1806_05246")
        a = new Cms_1806_05246();
    else if(analysisName == "cms_1806_04771")
        a = new Cms_1806_04771();
    else if(analysisName == "cms_1805_04865")
        a = new Cms_1805_04865();
    else if(analysisName == "cms_1807_02048")
        a = new Cms_1807_02048();
    else if(analysisName == "cms_1807_07799")
        a = new Cms_1807_07799();
    else if(analysisName == "cms_1808_03684")
        a = new Cms_1808_03684();
    else if(analysisName == "cms_1801_03957")
        a = new Cms_1801_03957();
    else if(analysisName == "cms_1704_03366")
        a = new Cms_1704_03366();
    else //@@extracode@@
        Global::abort(name,
