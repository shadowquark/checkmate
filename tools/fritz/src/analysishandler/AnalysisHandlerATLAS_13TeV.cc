...
void AnalysisHandlerATLAS_13TeV::bookAnalysis(std::string analysisName,
    ...
    else if(analysisName == "atlas_1709_07703_13")
        a = new Atlas_1709_07703_13();
    else if(analysisName == "atlas_1709_07242_13")
        a = new Atlas_1709_07242_13();
    else if(analysisName == "atlas_1712_02304")
        a = new Atlas_1712_02304();
    else if(analysisName == "atlas_1803_02762")
        a = new Atlas_1803_02762();
    else if(analysisName == "atlas_1807_06573")
        a = new Atlas_1807_06573();
    else if(analysisName == "atlas_1808_01191")
    ...
    else if(analysisName == "atlas_1902_05892")
        a = new Atlas_1902_05892();
    else //@@extracode@@
        Global::abort(name,
