...
void AnalysisHandlerCMS_8TeV::bookAnalysis(std::string analysisName,
    ...
    else if(analysisName == "cms_1410_6679_mumu2j")
        a = new Cms_1410_6679_mumu2j();
    else if(analysisName == "cms_1606_01522_8")
        a = new Cms_1606_01522_8();
    else if(analysisName == "cms_1506_00424_8")
        a = new Cms_1506_00424_8();
    else if(analysisName == "cms_1701_02032_8_4t")
        a = new Cms_1701_02032_8_4t();
    else if(analysisName == "cms_1701_02032_8_2mu2b")
        a = new Cms_1701_02032_8_2mu2b();
    else if(analysisName == "cms_1701_02032_8_2mu2t")
        a = new Cms_1701_02032_8_2mu2t();
    else if(analysisName == "cms_1507_03268_8")
        a = new Cms_1507_03268_8();
    else //@@extracode@@
        Global::abort(name,
