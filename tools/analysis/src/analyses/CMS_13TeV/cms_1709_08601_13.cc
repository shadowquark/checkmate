...
void Cms_1709_08601_13::initialize() {
  setAnalysisName("cms_1709_08601_13");          
  setInformation(""
    "# cms 1709.08601 13TeV 35.9/fb 4mu\n"
  "");
...
void Cms_1709_08601_13::analyze() {
  ...
  // - If you need output to be stored in other files than the cutflow/signal files we provide, check the manual for how to do this conveniently.  
	...
	int totCharge = 0;
	for ( int i = 0 ; i < 4 ; ++ i )
		totCharge += muonsCombined[i]->Charge;
	if (totCharge)	return;
