...
CFLAGS = -g -O2
CPP = gcc -E
CPPFLAGS =  -I/home/shadowquark/code/github/checkmate/tools/pythia/include  -I/home/shadowquark/code/github/checkmate/tools/delphes -I/home/shadowquark/code/github/checkmate/tools/delphes/external -I/home/shadowquark/root/include
CREATE_HEPMC = 
CXX = g++
CXXCPP = g++ -E
...
DSYMUTIL = 
DUMPBIN = 
DYLD_LIBRARY_PATH = /home/shadowquark/root/lib:/home/shadowquark/root/lib
ECHO_C = 
ECHO_N = -n
ECHO_T = 
EGREP = /bin/grep -E
...
ROOTCFLAGS = -I/home/shadowquark/root/include
ROOTCINT = /home/shadowquark/root/bin/rootcint
ROOTCONF = /home/shadowquark/root/bin/root-config
ROOTETCDIR = /home/shadowquark/root/etc
ROOTEXEC = /home/shadowquark/root/bin/root
...
ROOTINCDIR = /home/shadowquark/root/include
ROOTLIBDIR = /home/shadowquark/root/lib
...
ROOTRPATH = /home/shadowquark/root/lib
ROOTSOVERSION = 6.14
ROOTSYS = /home/shadowquark/root
ROOTSYSTEM = /home/shadowquark/root
ROOTVERSION = 6.14/00
SED = /bin/sed
SET_MAKE = 
SHELL = /bin/bash
...
all:
	@rm -f bin/CheckMATE;
	@sed 's,sys\.path\.append.*,sys\.path\.append("/home/shadowquark/root/lib"),g' tools/python/calculate_zsig.py.raw | \
        sed 's,cdll\.LoadLibrary(.*/libCint.so\"),cdll\.LoadLibrary("/home/shadowquark/root/lib/libCint.so\"),' | \
        sed 's,os\.path\.isfile(.*/libCint.so\"),os\.path\.isfile("/home/shadowquark/root/lib/libCint.so\"),' | \
        sed 's,cdll\.LoadLibrary(.*/libCore.so\"),cdll\.LoadLibrary("/home/shadowquark/root/lib/libCore.so\"),' | \
        sed 's,os\.path\.isfile(.*/libCore.so\"),os\.path\.isfile("/home/shadowquark/root/lib/libCore.so\"),' | \
        sed 's,cdll\.LoadLibrary(.*/libThread.so\"),cdll\.LoadLibrary("/home/shadowquark/root/lib/libThread.so\"),' | \
        sed 's,os\.path\.isfile(.*/libThread.so\"),os\.path\.isfile("/home/shadowquark/root/lib/libThread.so\"),' | \
        sed 's,cdll\.LoadLibrary(.*/libRIO.so\"),cdll\.LoadLibrary("/home/shadowquark/root/lib/libRIO.so\"),' | \
        sed 's,os\.path\.isfile(.*/libRIO.so\"),os\.path\.isfile("/home/shadowquark/root/lib/libRIO.so\"),' | \
        sed 's,cdll\.LoadLibrary(.*/libMathCore.so\"),cdll\.LoadLibrary("/home/shadowquark/root/lib/libMathCore.so\"),'  | \
        sed 's,os\.path\.isfile(.*/libMathCore.so\"),os\.path\.isfile("/home/shadowquark/root/lib/libMathCore.so\"),'  | \
        sed 's,cdll\.LoadLibrary(.*/libNet.so\"),cdll\.LoadLibrary("/home/shadowquark/root/lib/libNet.so\"),'  | \
        sed 's,os\.path\.isfile(.*/libNet.so\"),os\.path\.isfile("/home/shadowquark/root/lib/libNet.so\"),'  | \
        sed 's,cdll\.LoadLibrary(.*/libTree.so\"),cdll\.LoadLibrary("/home/shadowquark/root/lib/libTree.so\"),'  | \
        sed 's,os\.path\.isfile(.*/libTree.so\"),os\.path\.isfile("/home/shadowquark/root/lib/libTree.so\"),' > tools/python/calculate_zsig.py;
	@$(MAKE) install;
